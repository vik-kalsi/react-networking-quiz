    ...
    <>
      ...
      <div className='border-4 p-4'>
        ...
        <div className='w-2xs md:w-xl'>
          <h1 className='font-bold md:text-4xl'>Question 13: Which protocol allows secure remote login to a server?</h1>
        </div>
        ...
        <div className='grid mt-3 gap-4 md:gap-6'>
          ...
          <button className='border-2 p-1 font-bold cursor-pointer md:text-3xl' onClick={correctAnswer}>SSH</button>
          <button className='border-2 p-1 font-bold cursor-pointer md:text-3xl' onClick={wrongAnswer}>FTP</button>
          <button className='border-2 p-1 font-bold cursor-pointer md:text-3xl' onClick={wrongAnswer}>POP3</button>
        </div>
